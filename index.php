...
<body>
  ...
  const data={
    experience:[
        {role:'Project Leader',where:'i‑exceed Technology Solutions',when:'Oct 2019 – Present',high:['Led Appzillon banking framework implementation for clients including IPPB, Bandhan, UCBL, Canara, Equitas, Bank Islam, BOA, Al-Mashraf, NBF, CBoI','Managed team of 11 for Middleware, Cloud, DevOps, and AppSec','Oversaw Azure administration, migration strategies, performance tuning, and security','Pioneered microservices with OpenShift and Kubernetes','Built DevSecOps strategies and pipeline for multiple projects in a Master and Master-Slave environment of Jenkins','Led AppSec and performance resolution teams','Disaster Recovery setup in On-premises and Azure Cloud']},
